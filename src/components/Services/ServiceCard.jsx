const ServiceCard = ({ servicesName, serviceDetails, index }) => {
  return (
    <div
      className={`${
        index == 0 ? "bg-blue-800 text-white" : "bg-white"
      } flex border px-8 py-8 rounded-md shadow flex-col justify-start items-start gap-5 border-r border-r-gray-200 duration-300 hover:bg-blue-800 hover:text-white transition-all ease-in-out`}
    >
